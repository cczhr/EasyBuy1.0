...
public class NewAppWidget2 extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setTextColor(R.id.textView, Color.WHITE);
        views.setTextViewText(R.id.t1,"扫一扫");
        views.setTextColor(R.id.t1,Color.WHITE);
        views.setTextViewText(R.id.t2,"收付款");
        views.setTextColor(R.id.t2,Color.WHITE);
        views.setTextViewText(R.id.t3,"扫一扫");
        views.setTextColor(R.id.t3,Color.WHITE);
        views.setTextViewText(R.id.t4,"收付款");
        views.setTextColor(R.id.t4, Color.WHITE);
